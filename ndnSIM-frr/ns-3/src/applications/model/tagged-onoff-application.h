#ifndef SRC_APPLICATIONS_MODEL_TAGGED_ONOFF_APPLICATION_H_
#define SRC_APPLICATIONS_MODEL_TAGGED_ONOFF_APPLICATION_H_
...
*/
class TaggedOnOffApplication : public Application
{
public:
  /**
  ...
  virtual ~TaggedOnOffApplication();
...
#endif /* SRC_APPLICATIONS_MODEL_TAGGED_ONOFF_APPLICATION_H_ */
