...
public:
  static void setExtensionLltcPrefix(std::string* lltcPrefix);
  static void setExtensionLltcPitDurationInMilliSecs(int milliSecs);
  static void setExtensionStreamingPrefix(std::string* streamingPrefix);
  static void setExtensionStreamingPitDurationInMilliSecs(int milliSecs);
...
public:
  static std::string* extensionLltcPrefix;
  static time::milliseconds extensionLltcPitDuration;
  static std::string* extensionStreamingPrefix;
  static time::milliseconds extensionStreamingPitDuration;
  fw::Strategy* lltcStrategy;
};
