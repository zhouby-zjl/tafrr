...
public: // consumer
                       ...
                       const TimeoutCallback& afterTimeout)
  {
    ...
    addFieldFromTag<lp::LltcRsgIdField, lp::LltcRsgIdTag>(lpPacket, interest2);
...
public: // producer
  ...
  asyncPutData(const Data& data)
  {
    ...
    addFieldFromTag<lp::LltcPathIdField, lp::LltcPathIdTag>(lpPacket, data);
    addFieldFromTag<lp::LltcTransientField, lp::LltcTransientTag>(lpPacket, data);
    addFieldFromTag<lp::LltcRsgIdField, lp::LltcRsgIdTag>(lpPacket, data);
